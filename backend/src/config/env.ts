...
export const env = {
  ...
  DATABASE_URL: process.env.DATABASE_URL || "postgresql://neondb_owner:npg_rpMHAIsDc48F@ep-rough-sun-ae7h4n58-pooler.c-2.us-east-2.aws.neon.tech/neondb?channel_binding=require&sslmode=require",
